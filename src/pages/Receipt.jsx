...
const Receipt = () => {
  ...
  const handleAddressChange = (e) => {
    ...
    setFormData({...formData, address: addressQuery});
    ...
    setAddressResults(filteredSuggestions);
  };
      ...
      <TabsContent value='generate'>
        <main>
          ...
          <form>
            ...
            <div className='mb-4'>
              <Label htmlFor='chairNo'>Select Barber</Label>
              <Select
                isClearable={true}
                ...
                options={[
                  { value: "Shorif", label: 'Shorif' },
                  { value: "Raju", label: 'Raju' },
                  { value: "Rakib", label: 'Rakib' },
                ]}
                styles={{
                  control: (baseStyles, state) => ({
                    ...baseStyles,
